...
//	echo "### GPC: gpc_get 001 $_POST[" . $p_var_name ."] =" . $_POST[$p_var_name];
//	echo "### GPC: gpc_get 002 $_GET[" .$p_var_name . "] =" . $_POST[$p_var_name];
...
//	echo "### GPC: gpc_get 003" .  $p_default;
