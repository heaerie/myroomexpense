...
function html_page_top1( $p_page_title = null ) {
	...
	echo "\t", '<link rel="search" type="application/opensearchdescription+xml" title="Heaerie\'s-Sparrow: Text Search" href="' . string_sanitize_url( 'browser_search_plugin.php?type=text', true) . '" />';
	echo "\t", '<link rel="search" type="application/opensearchdescription+xml" title="Heaerie\'s-Sparrow: Issue Id" href="' . string_sanitize_url( 'browser_search_plugin.php?type=id', true) . '" />';
...
function html_footer( $p_file = null ) {
	...
	echo "\t<address>Copyright &copy; 2013 - ", date( 'Y' ), " Heaerie GSL.,Vellore.</address>\n";
