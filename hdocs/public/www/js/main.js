...
require.config({
   ...
   /* baseUrl: "js/lib", */
    paths: {
        ...
        , 'heaerieDocs'         : './lib/external/bootstrap/bootstrap-heaerieDoc'
		    , 'jqueryHotKeys'         : './lib/external/bootstrap/jquery.hotkeys'
    ...
    shim: {
       ...
       // , 'angularRoute'  : { exports:'angularRoute'}
        ...
        , 'app'            :{ 'deps':['angular','jquery','angularRoute','ngResource','angularUiRouter','angularAnimate','excanvas','jqueryFlot','jqueryFlotPie','toaster','ufi','ufi.frameGen','ufi.validate', 'ufi.xml' ,'heaerieDocs']}
