...
$stateProvider.state('basicDetUSSEdit', 
           ...
           ,views:{
             ...
             'pageMainContext' :
              ...
              {                
                ...
                ,controller :  'hdocController'//template : 'this is test'
               // templateUrl : 'view/loginView.html'
              }
            }
        });
   ...
   $stateProvider.state('HdocUSSNavi', 
        {
            url         : '/HdocUSSNavi'
           ,views:{
             ...
             'pageMainContext' :
              ...
              'pageSubContext@HdocUSSNavi' :
              {                
               
                //template : heaerieUssServiceProvider.GenHtmlTemplateFromSJson('basicDet','Y','SAVE')
                
                templateUrl : 'js/lib/views/hDoc.html'
