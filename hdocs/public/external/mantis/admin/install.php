		...
		switch( $f_db_type ) {
			...
			case 'mysqli':
				if( version_compare( $t_version_info['version'], '4.1.0', '<' ) ) {
					$t_error =  $t_version_info['version'] .  'MySQL 4.1.0 or later is required for installation.';
				}
				break;
			case 'mssql':
			case 'mssqlnative':
...
if( 6 == $t_install_state ) {
	...
	# post install checks
	?>
<table width="100%" bgcolor="#222222" border="0" cellpadding="10" cellspacing="1">/Library/WebServer/Documents/uss11.0.1/external/mantis/admin/index.php
<tr>
	<td bgcolor="#e8e8e8" colspan="2">
		<span class="title">Checking Installation...</span>
	</td>
