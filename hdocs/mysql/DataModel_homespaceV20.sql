...
START TRANSACTION;
USE `DBHSP`;
INSERT INTO `DBHSP`.`GID001MB` (`USR_ID`, `GRP_ID`, `F_NAME`, `L_NAME`, `EMAIL_ID`, `PASSWORD`, `LAST_LOGIN`, `LANG`, `DT_CREATED`, `DT_MODIFIED`, `MKR_ID`, `ATH_ID`, `STATUS`, `ADMIN_FLG`) VALUES (1, 1, 'DURAIMURUGAN', 'GOVINDARAJ', 'durai145@live.in', '1qaz2wsx', '01-jan-2015', 'ENG', '01-jan-2015', '01-jan-2015', 0, 0, 'ACTIVE', 'Y');
INSERT INTO `DBHSP`.`GID001MB` (`USR_ID`, `GRP_ID`, `F_NAME`, `L_NAME`, `EMAIL_ID`, `PASSWORD`, `LAST_LOGIN`, `LANG`, `DT_CREATED`, `DT_MODIFIED`, `MKR_ID`, `ATH_ID`, `STATUS`, `ADMIN_FLG`) VALUES (0, 0, 'SYSTEM', 'IMPLEMENTATION', 'system@myroomexpense.com', '1qaz2wsx', '01-jan-2015', 'ENG', '01-jan-2015', '01-jan-2015', 0, 0, 'ACTIVE', NULL);
INSERT INTO `DBHSP`.`GID001MB` (`USR_ID`, `GRP_ID`, `F_NAME`, `L_NAME`, `EMAIL_ID`, `PASSWORD`, `LAST_LOGIN`, `LANG`, `DT_CREATED`, `DT_MODIFIED`, `MKR_ID`, `ATH_ID`, `STATUS`, `ADMIN_FLG`) VALUES (2, 1, 'AGALYA', 'RAMADOSS', 'agalyadoss@gmial.com', '1qaz2wsx', '01-jan-2015', 'ENG', '01-jan-2015', '01-jan-2015', 0, 0, NULL, NULL);
